//######################################################################################################## 
//#                                                                                                    #\\
//#                               Global Surface UHI Explorer Version 4                                #\\
//#                                                                                                    #\\
//########################################################################################################
  

// date: 2018-11-29 (updated: 2019-11-20)
// authors: TC Chakraborty | tc.chakraborty@yale.edu | https://tc25.github.io/
// website: https://yceo.users.earthengine.app/view/uhimapv3 
// Web app version 5, but dataset version 4
...
var UHI_yearly=ee.Image('users/tirthankarchakraborty/UHI_yearly_v4')
//print(UHI_yearly)
...
var AllUHI=ee.Image('users/tirthankarchakraborty/UHI_all_seasons_v4')
//print(AllUHI)
...
var intro = ui.Panel([
  ...
  ui.Label({
    value:'This app displays surface urban heat islands (UHI) at a global scale from 2003 to 2018. Use the search bar or pan over the map to find your urban cluster of interest. Click anywhere within the boundary of an urban cluster, and the cluster mean statistics will be listed in the space below. You also have the option to subset and download the gridded surface UHI intensity rasters for the selected urban cluster at the bottom of the panel.',
...
style: {fontSize: '1.7vmin', fontWeight: 'bold', textAlign: 'center', margin: '0px 0px 0px 0px'}}));
  ...
  UHIChart.setOptions({
    ...
    hAxis: {title: 'Year', format: 'yyyy', gridlines: {count: 16}, titleTextStyle: {bold: true, italic: false}},
     curveType: 'function',
...
var UHI_yearly_1km=ee.Image('users/tirthankarchakraborty/UHI_yearly_300_v4')
...
Day2018_1km.addBands(Night2018_1km)]);
...
// Select images from a collection with a silder.
var Summer_UHI_yearly_1km=ee.Image('users/tirthankarchakraborty/Summer_UHI_yearly_300_v4');
...
, Summer_Day2014_1km.addBands(Summer_Night2014_1km), Summer_Day2015_1km.addBands(Summer_Night2015_1km), Summer_Day2016_1km.addBands(Summer_Night2016_1km), Summer_Day2017_1km.addBands(Summer_Night2017_1km),
 Summer_Day2018_1km.addBands(Summer_Night2018_1km)]);
...
// Select images from a collection with a silder.
var Winter_UHI_yearly_1km=ee.Image('users/tirthankarchakraborty/Winter_UHI_yearly_300_v4')
...
, Winter_Day2014_1km.addBands(Winter_Night2014_1km), Winter_Day2015_1km.addBands(Winter_Night2015_1km), Winter_Day2016_1km.addBands(Winter_Night2016_1km), Winter_Day2017_1km.addBands(Winter_Night2017_1km),
 Winter_Day2018_1km.addBands(Winter_Night2018_1km)]);

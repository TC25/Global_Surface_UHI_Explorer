//######################################################################################################## 
//#                                                                                                    #\\
//#                               Global Surface UHI Explorer Version 1                                #\\
//#                                                                                                    #\\
//########################################################################################################
...
var urb=ee.FeatureCollection('users/yceo/urban_Schneider_final_paper');
...
var AllUHI=ee.Image('users/yceo/UHI_all_seasons')
var AllUHI_1km=ee.Image('users/yceo/UHI_all_seasons_1km')

// Create layer selector
//var selectionpanel = ui.Panel({style: {width: '250px',position: 'bottom-right'}});
//Load annual means data
var UHI_yearly=ee.Image('users/yceo/UHI_yearly')
//print(UHI_yearly)
...
var UHI_monthly=ee.Image('users/yceo/UHI_monthly');

//######################################################################################################## 
//#                                                                                                    #\\
//#                               Global Surface UHI Explorer Version 2                                #\\
//#                                                                                                    #\\
//########################################################################################################
...
var UHI_yearly=ee.Image('users/yceo/UHI_yearly_vfF')
//print(UHI_yearly)
...
var AllUHI=ee.Image('users/yceo/UHI_all_seasons_vfF')
//print(AllUHI)
var AllUHI_1km=ee.Image('users/yceo/UHI_all_seasons_vfF')
//print(AllUHI_1km)

//Load monthly data image
var UHI_monthly=ee.Image('users/yceo/UHI_monthly_vfF');
...
var intro = ui.Panel([
  ...
  ui.Label({
    value:'This app displays urban heat islands (UHI) at a global scale. Use the search bar or click on the map to find your city. Once the UHI map appears, click anywhere on the map, and the cluster mean statistics will appear in the space below.',
...
function referencecreate(){
  ...
  var link1 = ui.Chart(
    ...
    'Table', {allowHtml: true, height: '3vw'});
...
inspector.add(ui.Label({value: 'Click on an urban cluster to extract its UHI statistics',
...
style: {fontSize: '1.7vmin', fontWeight: 'bold', textAlign: 'center', margin: '0px 0px 0px 0px'}}));
  ...
  UHIChart.setOptions({
    title: 'Longterm change of annual UHI intensity',
      vAxes: {
        0: {
          title: 'Annual daytime UHI (°C)', format: '#.##',  titleTextStyle: {bold: true, color: '#bd0026', italic: false}
        },
        1: {
          title: 'Annual nighttime UHI (°C)', format: '#.##',  titleTextStyle: {bold: true, color: '#313695', italic: false}
        }
      },
...
//var Months=['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
  ...
  mUHIChart.setOptions({
    title: 'Seasonal variability of UHI intensity',
      vAxes: {
        0: {
          title: 'Monthly daytime UHI (°C)', format: '#.##',  titleTextStyle: {bold: true, color: '#bd0026', italic: false}
        },
        1: {
          title: 'Monthly nighttime UHI (°C)', format: '#.##',  titleTextStyle: {bold: true, color: '#313695', italic: false}
        }
      },
...
var UHI_yearly_1km=ee.Image('users/yceo/UHI_yearly_1km_vfF')
var Day2003_1km = UHI_yearly_1km.select(['a_daytime_UHI'],['Daytime']).set( 'system:time_start','2003','system:time_end','2003')
var Night2003_1km = UHI_yearly_1km.select(['a_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2003','system:time_end','2003')
var Day2004_1km = UHI_yearly_1km.select(['b_daytime_UHI'],['Daytime']).set( 'system:time_start','2004','system:time_end','2004')
var Night2004_1km = UHI_yearly_1km.select(['b_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2004','system:time_end','2004')
var Day2005_1km = UHI_yearly_1km.select(['c_daytime_UHI'],['Daytime']).set( 'system:time_start','2005','system:time_end','2005')
var Night2005_1km = UHI_yearly_1km.select(['c_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2005','system:time_end','2005') 
var Day2006_1km = UHI_yearly_1km.select(['d_daytime_UHI'],['Daytime']).set( 'system:time_start','2006','system:time_end','2006')
var Night2006_1km = UHI_yearly_1km.select(['d_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2006','system:time_end','2006')
var Day2007_1km = UHI_yearly_1km.select(['e_daytime_UHI'],['Daytime']).set( 'system:time_start','2007','system:time_end','2007') 
var Night2007_1km = UHI_yearly_1km.select(['e_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2007','system:time_end','2007')
var Day2008_1km = UHI_yearly_1km.select(['f_daytime_UHI'],['Daytime']).set( 'system:time_start','2008','system:time_end','2008')
var Night2008_1km = UHI_yearly_1km.select(['f_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2008','system:time_end','2008')
var Day2009_1km = UHI_yearly_1km.select(['g_daytime_UHI'],['Daytime']).set( 'system:time_start','2009','system:time_end','2009')
var Night2009_1km = UHI_yearly_1km.select(['g_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2009','system:time_end','2009')
var Day2010_1km = UHI_yearly_1km.select(['h_daytime_UHI'],['Daytime']).set( 'system:time_start','2010','system:time_end','2010')
var Night2010_1km = UHI_yearly_1km.select(['h_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2010','system:time_end','2010')
var Day2011_1km = UHI_yearly_1km.select(['i_daytime_UHI'],['Daytime']).set( 'system:time_start','2011','system:time_end','2011')
var Night2011_1km = UHI_yearly_1km.select(['i_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2011','system:time_end','2011')
var Day2012_1km = UHI_yearly_1km.select(['j_daytime_UHI'],['Daytime']).set( 'system:time_start','2012','system:time_end','2012')
var Night2012_1km = UHI_yearly_1km.select(['j_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2012','system:time_end','2012')
var Day2013_1km = UHI_yearly_1km.select(['k_daytime_UHI'],['Daytime']).set( 'system:time_start','2013','system:time_end','2013')
var Night2013_1km = UHI_yearly_1km.select(['k_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2013','system:time_end','2013')
var Day2014_1km = UHI_yearly_1km.select(['l_daytime_UHI'],['Daytime']).set( 'system:time_start','2014','system:time_end','2014')
var Night2014_1km = UHI_yearly_1km.select(['l_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2014','system:time_end','2014')
var Day2015_1km = UHI_yearly_1km.select(['m_daytime_UHI'],['Daytime']).set( 'system:time_start','2015','system:time_end','2015')
var Night2015_1km = UHI_yearly_1km.select(['m_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2015','system:time_end','2015')
var Day2016_1km = UHI_yearly_1km.select(['n_daytime_UHI'],['Daytime']).set( 'system:time_start','2016','system:time_end','2016')
var Night2016_1km = UHI_yearly_1km.select(['n_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2016','system:time_end','2016')
var Day2017_1km = UHI_yearly_1km.select(['o_daytime_UHI'],['Daytime']).set( 'system:time_start','2017','system:time_end','2017')
var Night2017_1km = UHI_yearly_1km.select(['o_nighttime_UHI'],['Nighttime']).set( 'system:time_start','2017','system:time_end','2017')
...
// Select images from a collection with a silder.
var Summer_UHI_yearly_1km=ee.Image('users/yceo/Summer_UHI_yearly_1km_vfF');
var Summer_Day2003_1km = Summer_UHI_yearly_1km.select(['a_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2003','system:time_end','2003');
var Summer_Night2003_1km = Summer_UHI_yearly_1km.select(['a_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2003','system:time_end','2003');
var Summer_Day2004_1km = Summer_UHI_yearly_1km.select(['b_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2004','system:time_end','2004');
var Summer_Night2004_1km = Summer_UHI_yearly_1km.select(['b_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2004','system:time_end','2004');
var Summer_Day2005_1km = Summer_UHI_yearly_1km.select(['c_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2005','system:time_end','2005');
var Summer_Night2005_1km = Summer_UHI_yearly_1km.select(['c_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2005','system:time_end','2005') ;
var Summer_Day2006_1km = Summer_UHI_yearly_1km.select(['d_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2006','system:time_end','2006');
var Summer_Night2006_1km = Summer_UHI_yearly_1km.select(['d_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2006','system:time_end','2006');
var Summer_Day2007_1km = Summer_UHI_yearly_1km.select(['e_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2007','system:time_end','2007') ;
var Summer_Night2007_1km = Summer_UHI_yearly_1km.select(['e_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2007','system:time_end','2007');
var Summer_Day2008_1km = Summer_UHI_yearly_1km.select(['f_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2008','system:time_end','2008');
var Summer_Night2008_1km = Summer_UHI_yearly_1km.select(['f_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2008','system:time_end','2008');
var Summer_Day2009_1km = Summer_UHI_yearly_1km.select(['g_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2009','system:time_end','2009');
var Summer_Night2009_1km = Summer_UHI_yearly_1km.select(['g_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2009','system:time_end','2009');
var Summer_Day2010_1km = Summer_UHI_yearly_1km.select(['h_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2010','system:time_end','2010');
var Summer_Night2010_1km = Summer_UHI_yearly_1km.select(['h_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2010','system:time_end','2010');
var Summer_Day2011_1km = Summer_UHI_yearly_1km.select(['i_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2011','system:time_end','2011');
var Summer_Night2011_1km = Summer_UHI_yearly_1km.select(['i_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2011','system:time_end','2011');
var Summer_Day2012_1km = Summer_UHI_yearly_1km.select(['j_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2012','system:time_end','2012');
var Summer_Night2012_1km = Summer_UHI_yearly_1km.select(['j_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2012','system:time_end','2012');
var Summer_Day2013_1km = Summer_UHI_yearly_1km.select(['k_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2013','system:time_end','2013');
var Summer_Night2013_1km = Summer_UHI_yearly_1km.select(['k_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2013','system:time_end','2013');
var Summer_Day2014_1km = Summer_UHI_yearly_1km.select(['l_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2014','system:time_end','2014');
var Summer_Night2014_1km = Summer_UHI_yearly_1km.select(['l_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2014','system:time_end','2014');
var Summer_Day2015_1km = Summer_UHI_yearly_1km.select(['m_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2015','system:time_end','2015');
var Summer_Night2015_1km = Summer_UHI_yearly_1km.select(['m_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2015','system:time_end','2015');
var Summer_Day2016_1km = Summer_UHI_yearly_1km.select(['n_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2016','system:time_end','2016');
var Summer_Night2016_1km = Summer_UHI_yearly_1km.select(['n_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2016','system:time_end','2016');
var Summer_Day2017_1km = Summer_UHI_yearly_1km.select(['o_summerdaytime_UHI'],['Summerdaytime']).set( 'system:time_start','2017','system:time_end','2017');
var Summer_Night2017_1km = Summer_UHI_yearly_1km.select(['o_summernighttime_UHI'],['Summernighttime']).set( 'system:time_start','2017','system:time_end','2017')
...
// Select images from a collection with a silder.
var Winter_UHI_yearly_1km=ee.Image('users/yceo/Winter_UHI_yearly_1km_vfF')
var Winter_Day2003_1km = Winter_UHI_yearly_1km.select(['a_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2003','system:time_end','2003')
var Winter_Night2003_1km = Winter_UHI_yearly_1km.select(['a_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2003','system:time_end','2003')
var Winter_Day2004_1km = Winter_UHI_yearly_1km.select(['b_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2004','system:time_end','2004')
var Winter_Night2004_1km = Winter_UHI_yearly_1km.select(['b_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2004','system:time_end','2004')
var Winter_Day2005_1km = Winter_UHI_yearly_1km.select(['c_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2005','system:time_end','2005')
var Winter_Night2005_1km = Winter_UHI_yearly_1km.select(['c_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2005','system:time_end','2005') 
var Winter_Day2006_1km = Winter_UHI_yearly_1km.select(['d_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2006','system:time_end','2006')
var Winter_Night2006_1km = Winter_UHI_yearly_1km.select(['d_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2006','system:time_end','2006')
var Winter_Day2007_1km = Winter_UHI_yearly_1km.select(['e_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2007','system:time_end','2007') 
var Winter_Night2007_1km = Winter_UHI_yearly_1km.select(['e_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2007','system:time_end','2007')
var Winter_Day2008_1km = Winter_UHI_yearly_1km.select(['f_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2008','system:time_end','2008')
var Winter_Night2008_1km = Winter_UHI_yearly_1km.select(['f_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2008','system:time_end','2008')
var Winter_Day2009_1km = Winter_UHI_yearly_1km.select(['g_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2009','system:time_end','2009')
var Winter_Night2009_1km = Winter_UHI_yearly_1km.select(['g_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2009','system:time_end','2009')
var Winter_Day2010_1km = Winter_UHI_yearly_1km.select(['h_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2010','system:time_end','2010')
var Winter_Night2010_1km = Winter_UHI_yearly_1km.select(['h_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2010','system:time_end','2010')
var Winter_Day2011_1km = Winter_UHI_yearly_1km.select(['i_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2011','system:time_end','2011')
var Winter_Night2011_1km = Winter_UHI_yearly_1km.select(['i_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2011','system:time_end','2011')
var Winter_Day2012_1km = Winter_UHI_yearly_1km.select(['j_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2012','system:time_end','2012')
var Winter_Night2012_1km = Winter_UHI_yearly_1km.select(['j_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2012','system:time_end','2012')
var Winter_Day2013_1km = Winter_UHI_yearly_1km.select(['k_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2013','system:time_end','2013')
var Winter_Night2013_1km = Winter_UHI_yearly_1km.select(['k_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2013','system:time_end','2013')
var Winter_Day2014_1km = Winter_UHI_yearly_1km.select(['l_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2014','system:time_end','2014')
var Winter_Night2014_1km = Winter_UHI_yearly_1km.select(['l_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2014','system:time_end','2014')
var Winter_Day2015_1km = Winter_UHI_yearly_1km.select(['m_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2015','system:time_end','2015')
var Winter_Night2015_1km = Winter_UHI_yearly_1km.select(['m_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2015','system:time_end','2015')
var Winter_Day2016_1km = Winter_UHI_yearly_1km.select(['n_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2016','system:time_end','2016')
var Winter_Night2016_1km = Winter_UHI_yearly_1km.select(['n_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2016','system:time_end','2016')
var Winter_Day2017_1km = Winter_UHI_yearly_1km.select(['o_winterdaytime_UHI'],['Winterdaytime']).set( 'system:time_start','2017','system:time_end','2017')
var Winter_Night2017_1km = Winter_UHI_yearly_1km.select(['o_winternighttime_UHI'],['Winternighttime']).set( 'system:time_start','2017','system:time_end','2017')
...
var select = ui.Select({
  items: [YEARLY_DAY_UHI, YEARLY_NIGHT_UHI, SUMMER_DAY_UHI, SUMMER_NIGHT_UHI, WINTER_DAY_UHI, WINTER_NIGHT_UHI],
...
var slider_label = ui.Label({value: 'Daytime surface UHI intensity for year', style: {fontSize: '2.0vmin', fontWeight: 'bold'}});  
...
// Create a label and slider.
var slider_label = ui.Label({value: 'Nighttime surface UHI intensity for year',style: {fontSize: '2.0vmin', fontWeight: 'bold'}});
var slider = ui.Slider({
  min: 2003,
  max: 2017,
  step: 1,
...
// Create a label and slider.
var slider_label = ui.Label({value: 'Daytime surface UHI intensity for summer of', style: {fontSize: '2.0vmin', fontWeight: 'bold'}});
var slider = ui.Slider({
  min: 2003,
  max: 2017,
  step: 1,
...
// Create a label and slider.
var slider_label = ui.Label({value: 'Nighttime surface UHI intensity for summer of', style: {fontSize: '2.0vmin', fontWeight: 'bold'}});
var slider = ui.Slider({
  min: 2003,
  max: 2017,
  step: 1,
...
// Create a label and slider.
var slider_label = ui.Label({value: 'Daytime surface UHI intensity for winter of', style: {fontSize: '2.0vmin', fontWeight: 'bold'}});
var slider = ui.Slider({
  min: 2003,
  max: 2017,
  step: 1,
...
// Create a label and slider.
var slider_label = ui.Label({value: 'Nighttime surface UHI intensity for winter of', style: {fontSize: '2.0vmin', fontWeight: 'bold'}});
var slider = ui.Slider({
  min: 2003,
  max: 2017,
  step: 1,
